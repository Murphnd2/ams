...
public class BillingLink {
    ...
    public net.superiorstate.ams.previous.model.summit.imports.sEmployer getsEmployer() {
        return sEmployer;
    }

    public void setsEmployer(net.superiorstate.ams.previous.model.summit.imports.sEmployer sEmployer) {
