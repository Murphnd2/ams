...
public abstract class dbTicket {
    ...
    public static List<SortedTask> getTasksRequiredForTheTicket(EntityManager em, Ticket t){
        ...
        TicketSubCategory tsc = dM.getSubCategoryById(em,t.getTicketSubCategory().getId());
        TemplatePurpose tp = dM.getTemplatePurposeById(em,tsc.getTemplatePurpose().getId());
