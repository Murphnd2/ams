...
@WebServlet(name = "RemoveRenewalContact", value = "/RemoveRenewalContact")
public class RemoveRenewalContact extends HttpServlet {
    @Override
    ...
    private void changeView(HttpServletRequest request){
        ...
        int id = Integer.parseInt(request.getParameter("contactList"));
        ...
        dbEe.removeEmployeeContact(em,ee,er);
