...
@WebServlet(name = "Send125Reminder", value = "/Send125Reminder")
public class Send125Reminder extends HttpServlet {
    @Override
    ...
    private void sendQuickAction(HttpServletRequest request) throws MessagingException {
        ...
        String eMessage = Q.qText(em,a,Q.TEST_ELIGIBILITY) + Q.insert125Test(a) + StdAuto.userSignature(p);
