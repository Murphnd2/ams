...
@WebServlet(name = "WelcomeNewPop", value = "/WelcomeNewPop")
public class WelcomeNewPop extends HttpServlet {
    @Override
    ...
    private void sendQuickAction(HttpServletRequest request) throws MessagingException {
        ...
        StdAuto.closeThisTask(em,a,6467L,p);
        em.close();
    }
}
