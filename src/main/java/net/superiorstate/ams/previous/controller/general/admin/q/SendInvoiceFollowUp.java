...
@WebServlet(name = "SendInvoiceFollowUp", value = "/SendInvoiceFollowUp")
public class SendInvoiceFollowUp extends HttpServlet {
    @Override
    ...
    private void sendQuickAction(HttpServletRequest request) throws MessagingException {
        ...
        String eSubject = a.getFullName() + ": Annual Fee Outstanding";
    ...
    private String getMessage(Activity a){
        Renewal r = (Renewal) a;
        if(Q.isPop(r))
            return Q.POP_WAITING_ON_PAYMENT;
        return Q.FEE_OUTSTANDING;
    }
}
