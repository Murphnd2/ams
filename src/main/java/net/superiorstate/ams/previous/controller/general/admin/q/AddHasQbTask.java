...
@WebServlet(name = "AddHasQbTask", value = "/AddHasQbTask")
public class AddHasQbTask extends HttpServlet {
    @Override
    ...
    private void closeThisTask(EntityManager em, Renewal r, Person p, Long taskId){
        ...
        System.out.println("went through close");
    }
    private void sendQuickAction(HttpServletRequest request) throws MessagingException {
        ...
        Q.addNextTask(request,em,r,p,565L,99999);
        closeThisTask(em,r,p,565L);
        closeThisTask(em,r,p,2602L);
