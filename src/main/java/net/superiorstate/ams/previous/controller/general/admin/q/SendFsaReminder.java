...
@WebServlet(name = "SendFsaReminder", value = "/SendFsaReminder")
public class SendFsaReminder extends HttpServlet {
    @Override
    ...
    private void sendQuickAction(HttpServletRequest request) throws MessagingException {
        ...
        String eSubject = "Check-In: FSA Enrollment Status";
        Renewal r = (Renewal) a;
        String eMessage = Q.qText(em,r,Q.FSA_WAIT_ON_ENROLL) + Q.insertSRA(em) + StdAuto.userSignature(p);
