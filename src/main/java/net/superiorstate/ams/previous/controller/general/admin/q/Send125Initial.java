...
@WebServlet(name = "Send125Initial", value = "/Send125Initial")
public class Send125Initial extends HttpServlet {
    @Override
    ...
    private void sendQuickAction(HttpServletRequest request) throws MessagingException {
        ...
        String eSubject = a.getFullName() +  ": 125 Plan Non-Discrimination Testing";

        String eMessage = Q.TEST_ELIGIBILITY + Q.insert125Test(Math.toIntExact((Long) a.getId()),a.getFullName()) + StdAuto.userSignature(p);
        ...
        StdAuto.closeThisTask(em,a,5082L,p);
