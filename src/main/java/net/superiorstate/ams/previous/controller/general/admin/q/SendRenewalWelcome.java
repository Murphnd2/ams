...
@WebServlet(name = "SendRenewalWelcome", value = "/SendRenewalWelcome")
public class SendRenewalWelcome extends HttpServlet {
    @Override
    ...
    private void sendQuickAction(HttpServletRequest request) throws MessagingException {
        ...
        String eSubject = "Superior State Annual Benefit Renewal Starting";
        String eMessage = getMessage(a)  + StdAuto.userSignature(p);
        ...
        StdAuto.closeThisTask(em,a,551L,p);
    ...
    private String getMessage(Activity a){
        Renewal r = (Renewal) a;
        if(Q.isPop(r))
            return Q.WELCOME_RENEWAL_POP;
        return Q.WELCOME_RENEWAL_GENERAL;
    }
