...
@WebServlet(name = "createTicket3", value = "/createTicket3")
public class createTicket3 extends HttpServlet {
    ...
    private void createTicketAlt(HttpServletRequest request) {
        ...
        try{
            ...
            activityOutList = new ArrayList<>();
        }
        for(ActivityOut a:activityOutList)
            if(a.getActivity().getId().equals(t.getId()))
                em.refresh(a);
