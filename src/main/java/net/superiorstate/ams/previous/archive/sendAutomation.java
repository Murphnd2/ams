...
@WebServlet(name = "sendAutomation", value = "/sendAutomation")
public class sendAutomation extends HttpServlet {
    ...
    private void action(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher d = getServletContext().getNamedDispatcher("sendAutomationFinal");
        if(count>0)
            d = request.getRequestDispatcher("/WEB-INF/view/autoInputScreen.jsp");
