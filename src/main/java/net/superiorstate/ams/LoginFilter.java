...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        boolean allowedPath = ALLOWED_ENDPOINTS.contains(path) || path.startsWith("/proposal/") || path.startsWith("/apply/") || path.startsWith("/q/") || path.equals("/saveQuestionnaire") || path.startsWith("/tpo") || path.equals("/uploadRateSheet") || path.equals("/saveApplication") || path.startsWith("/video") || path.startsWith("/outlook/");
