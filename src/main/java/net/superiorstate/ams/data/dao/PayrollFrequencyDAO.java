 ...
 * <p>
 * <b>No hardcoded row ids.</b> Callers ask by code or by the enrollment-approved flag — never
 * by id literal, since the table ships empty and every row is Kevin's to create.
 */
