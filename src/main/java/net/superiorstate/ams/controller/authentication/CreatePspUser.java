...
@WebServlet(name = "CreatePspUser", value = "/CreatePspUser")
public class CreatePspUser extends HttpServlet {
    @Override
    ...
    private User generateUser(HttpServletRequest request) throws NoSuchAlgorithmException {
        ...
        Person admin = (Person) request.getSession().getAttribute("currentPerson");
