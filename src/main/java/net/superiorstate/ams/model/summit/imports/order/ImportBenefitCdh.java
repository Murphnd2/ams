...
public class ImportBenefitCdh {
    ...
    public net.superiorstate.ams.model.summit.archive.PlanType getPlanType() {
        return PlanType;
    }
    ...
    public void setPlanType(net.superiorstate.ams.model.summit.archive.PlanType planType) {
        PlanType = planType;
    }
