...
<form method="post" action="MakeRecurringFromChecklist">
    ...
    <div class="row mt-1">
      ...
      <div class="col-12 col-md-7 mt-1">
        <input type="text" class="form-control form-control-sm" name="sequenceName" id="sequenceName" required
               placeholder="Name of the Recurring Checklist Goes Here" value="${sessionScope.currentChecklist.getFullName()}">
      </div>
    </div>
    <div class="row mt-1">
      <div class="col-12 col-md-5 mt-1">
      ...
      <div class="col-12 col-md-7 mt-1">
        <input class="form-control form-control-sm" type="date" name="startDate" id="startDate" required value="${sessionScope.currentChecklist.getDueDate()}">
      </div>
    </div>
    <div class="row mt-1">
      <div class="col-12 col-md-5 mt-1">
