  ...
  <div class="row mb-3">
    <div class="col">
      <div class="input-group input-group-sm">
        ...
        <input type="email" class="form-control" id="email" name="email" required placeholder="name@email.com"/>
      </div>
    </div>
  </div>
  <div class="row mb-3">
  ...
  <div class="row mb-3">
    <div class="col">
      <div class="input-group input-group-sm">
        ...
        <input type="tel" class="form-control" id="personPhone" name="personPhone" placeholder="###-555-1234" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"/>
      </div>
    </div>
  </div>
</div>
