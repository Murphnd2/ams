...
<head>
    ...
    <title>Questionnaire Submitted — ${pspName}</title>
...
<div class="confirm-container">
    ...
    <c:choose>
        <c:when test="${alreadySubmitted}">
            <h2 style="color: var(--psp-primary); margin-bottom: 1rem;">Already Submitted</h2>
            <p class="mb-3">The questionnaire <strong>${questionnaireName}</strong> has already been submitted.</p>
            <p class="text-muted">If you need to make changes, please contact your administrator to have the questionnaire reopened.</p>
        </c:when>
        <c:otherwise>
            <h2 style="color: var(--psp-primary); margin-bottom: 1rem;">Questionnaire Submitted</h2>
            <p class="mb-3">Thank you! Your response for <strong>${questionnaireName}</strong> has been received.</p>
            <p class="text-muted">Our team will review your submission. You can close this page.</p>
        </c:otherwise>
    </c:choose>
</div>
