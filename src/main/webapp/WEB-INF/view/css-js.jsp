...
<c:set var="favPath" value="${not empty applicationScope.global.favicon ? applicationScope.global.favicon : '/favicon.ico'}"/>
<link rel="icon" href="${pageContext.request.contextPath}${favPath}" type="image/x-icon">
