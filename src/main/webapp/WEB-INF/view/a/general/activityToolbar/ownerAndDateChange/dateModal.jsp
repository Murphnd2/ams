...
<form method="post" action="changeDueDate" class="mb-1">
      ...
      <div class="accordion-header" id="changeDueDateHeader">
        <div class="input-group">
          <div class="form-control text-danger fw-bolder">
            Due on <fmt:formatDate value="${sessionScope.sVar.getCurrentActivity().getDueDate()}" pattern="MMMM dd, yyyy"></fmt:formatDate>
          </div>
      ...
      <div class="accordion-collapse collapse" id="changeDueDateBody">
        <div class="accordion-body p-0 m-0 mt-1">
          <div class="input-group w-100 mb-1">
            ...
            <input type="date" name="newDueDate" class="form-control text-danger" value="${sessionScope.sVar.getCurrentActivity().getDueDate()}">
