...
<form method="post" action="ChangeDueDate25" class="mb-1">
      ...
      <div class="accordion-header" id="changeDueDateHeader">
        <div class="input-group">
          <div class="form-control text-danger fw-bolder">
            Due on <fmt:formatDate value="${sessionScope.local.getCurrentActivity().getActivity().getDueDate()}" pattern="MMMM dd, yyyy"></fmt:formatDate>
          </div>
          <button type="button" data-bs-toggle="collapse" data-bs-target="#changeDueDateBody" class="btn btn-outline-danger ${penone}">
      ...
      <div class="accordion-collapse collapse" id="changeDueDateBody">
        <div class="accordion-body p-0 m-0 mt-1">
          <div class="input-group w-100">
            ...
            <input type="date" name="newDueDate" class="form-control text-danger ${penone}" value="${sessionScope.local.getCurrentActivity().getActivity().getDueDate()}">
