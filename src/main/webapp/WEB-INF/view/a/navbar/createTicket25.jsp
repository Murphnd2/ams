        ...
        <form method="post" action="CreateTicket25" id="thisForm01">
          <div class="row align-items-baseline">
            ...
            <div class="col-12 col-md-7 col-lg-8 col-xl-9 mt-1 mt-md-0">
              <c:import url="/WEB-INF/view/a/navbar/ddContactMethod25.jsp"></c:import>
            </div>
            ...
            <div class="col-12 col-md-7 col-lg-8 col-xl-9 mt-1 mt-md-3">
              ...
              <datalist id="datalistOptions1">
                <c:forEach var="employee" items="${applicationScope.global.getEmployees()}">
                ...
                document.addEventListener('DOMContentLoaded', function () {
                  ClassicEditor
                          ...
                          .then(editor => {
                            ...
                            // Set tabindex to maintain tab stop
                            editorElement.setAttribute('tabindex', '4');

                            // Handle custom Tab key behavior for navigating out of the editor
                            editor.ui.view.editable.element.addEventListener('keydown', event => {
                              if (event.key === 'Tab' && !event.shiftKey) {
                                event.preventDefault();

                                // Move focus to the next element with a higher tabindex
                                const nextTabIndex = 5; // Adjust to your next tab-indexed element
                                ...
                                // Move focus to the previous element with a lower tabindex
                                const previousTabIndex = 3; // Adjust to your previous tab-indexed element
                                const previousElement = document.querySelector(`[tabindex="${previousTabIndex}"]`);
                                if (previousElement) {
                            ...
                            // Synchronize editor data on form submission
