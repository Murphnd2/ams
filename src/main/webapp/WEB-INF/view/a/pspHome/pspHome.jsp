...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-7 col-xl-3 order-last">
            ...
            <c:import url="/WEB-INF/view/a/pspHome/columns/timeClock/timeClockDetail.jsp"></c:import>
        </div>
        ...
        <div class="col-12 col-lg-5 col-xl-3 order-2 order-xl-first">
            ...
            <c:import url="/WEB-INF/view/a/pspHome/columns/toDos/toDoCurrentList.jsp"></c:import>
            <c:import url="/WEB-INF/view/a/pspHome/columns/toDos/toDoFutureList.jsp"></c:import>
        </div>
    </div>
</div>
</body>
