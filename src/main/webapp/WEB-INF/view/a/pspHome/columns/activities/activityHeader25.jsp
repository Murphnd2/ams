...
<div class="p-2 pt-1 border border-dark rounded w-100 mt-2 mb-2 text-light bg-dark fw-bold fs-3 align-items-center text-center">
  <form action="FilterActivities25" method="post">
    <c:set var="af" value="${sessionScope.local.getActivityFilter()}"></c:set>
    ...
    <div class="row align-items-center">
      <div class="col-auto m-0 me-1">
        <div class="btn-group" role="group">
          <a id="seeAll" href="FilterActivities25?viewAllActivities=ALL" class="btn btn-outline-light" data-bs-toggle="tooltip" title="View All Open">
            <i class="bi bi-journal-text"></i>
          </a>
          <a href="FilterActivities25?viewAllActivities=MY" class="btn btn-outline-light" data-bs-toggle="tooltip" title="View My Actionable">
            <i class="bi bi-journal-check"></i>
          </a>
          <a href="FilterActivities25?viewAllActivities=REN" class="btn btn-outline-light" data-bs-toggle="tooltip" title="View All Renewals">
