          ...
          <div class="row mb-1">
            <div class="col">
              <div class="input-group">
                ...
                <c:choose>
                  <c:when test="${sessionScope.local.getCurrentActivity().getPrimaryContact().getEmployee()==null}">
                  ...
                  <c:when test="${sessionScope.local.getCurrentActivity().getPrimaryContact().getEmployee().getHrEmail()!=null && !sessionScope.local.getCurrentActivity().getPrimaryContact().getEmployee().getHrEmail().equals(\"\")}">
                    <input type="email" class="form-control" name="contactEmail" value="${sessionScope.local.getCurrentActivity().getPrimaryContact().getEmployee().getHrEmail().toLowerCase()}">
                  </c:when>
                  <c:when test="${sessionScope.local.getCurrentActivity().getPrimaryContact().getEmployee().getEmail()!=null && !sessionScope.local.getCurrentActivity().getPrimaryContact().getEmployee().getEmail().equals(\"\")}">
                    <input type="email" class="form-control" name="contactEmail" value="${sessionScope.local.getCurrentActivity().getPrimaryContact().getEmployee().getEmail().toLowerCase()}">
                  </c:when>
                  <c:otherwise>
                    <input type="email" class="form-control" name="contactEmail" value="${sessionScope.local.getCurrentActivity().getPrimaryContact().getEmail().toLowerCase()}">
                  </c:otherwise>
