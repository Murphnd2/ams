...
<div class="row m-1">
  <div class="col">
    <div class="row">
      <div class="col">
        <span class="text-danger fw-bolder fs-5">Add Notes To ${sessionScope.sVar.getCurrentActivity().getClass().getSimpleName()}</span>
      </div>
      <div class="col-auto"></div>
    </div>
    <form method="post" action="addNoteToItem" id="myForm" >
